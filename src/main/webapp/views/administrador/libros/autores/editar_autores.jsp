            ...
            <div class="card-body">
                <form id="autor-add-form" class="needs-validation" novalidate action="/api/autor/update" method="post">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="nombre" id="nombre" class="form-control" required maxlength="40" value="${autor.nombre}"/>
                    ...
                    <div class="form-group mb-3">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="apellido_paterno" id="ap" class="form-control" required maxlength="40" value="${autor.apellido_paterno}"/>
                                <div class="invalid-feedback">Campo obligatorio</div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="apellido_materno" id="am" class="form-control" required maxlength="40" value="${autor.apellido_materno}"/>
                                <div class="invalid-feedback">Campo obligatorio</div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    const form = document.getElementById("autor-add-form");
