            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        <!--Menu-->
                        <li class="nav-item">
                            <a class="nav-link" href="/libro/libros">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="...">Agregar Alumno</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/libro/libros">Consultar</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="/libro/libro_view">Agregar Libro</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="/autor/autores">Autores</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="/ubicacion/ubicaciones">Ubicaciones</a></li>
                            </ul>
                        </li>
                        <!--Opciones de salas-->
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/sala/salas">Consultar</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="/sala/sala-view">Agregar Sala</a></li>
                            </ul>
                        </li>
                        <!--Cerrar sesión-->
...
<c:if test="${rol==2}">
    ...
    <nav class="navbar bg-light fixed-top">
        <div class="container-fluid">
            ...
            <div class="col text-center">
                <a class="navbar-brand mb-0 h1" href="list_libros.html" style="color: #002e60; font-size: x-large;">SIBA</a>
                <br>
                Sistema Bibliotecario Académico
            </div>
            <img src="https://upload.wikimedia.org/wikipedia/commons/5/54/Logo-utez.png" style="width: 2.6cm; height: 50px;">
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        <!--Menu-->
                        <li class="nav-item">
                            <a class="nav-link" href="list_libros.html">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-house-fill" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="m8 3.293 6 6V13.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5V9.293l6-6zm5-.793V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
                                    <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
                                </svg> &nbsp; &nbsp;Inicio
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="agregar_alumno.html">Agregar alumno</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="agregar_docente.html">Agregar docente</a></li>
                            </ul>
                        </li>
                        <!--Opciones de libros-->
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="list_libros.html">Consultar</a></li>
                            </ul>
                        </li>
                        <!--Opciones de salas-->
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="list_salas.html">Consultar</a></li>
                            </ul>
                        </li>
...
<c:if test="${rol == 3 || role == 4}">
    ...
    <nav class="navbar bg-light fixed-top">
        <div class="container-fluid">
            ...
            <div class="col text-center">
                <a class="navbar-brand mb-0 h1" href="..." style="color: #002e60; font-size: x-large;">SIBA</a>
                <br>
                Sistema Bibliotecario Académico
            </div>
            <img src="https://upload.wikimedia.org/wikipedia/commons/5/54/Logo-utez.png" style="width: 2.6cm; height: 50px;">
